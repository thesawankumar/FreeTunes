...
// Context to handle the expanded state
...
interface SidebarProps {
  children: ReactNode;
  className?: string; // Allow className to be passed as a prop for customization
}

export default function SidebarExpanded({ children, className }: SidebarProps) {
  const [expanded, setExpanded] = useState(true); // Control the expanded state
...
export function SidebarExpandedItem({
  playlist,
  active,
  onSelect,
}) {
