...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-950 text-white">
      ...
      {isMainContent ? (
        <Sidebar className="w-full sm:w-1/4 md:w-1/5 lg:w-1/6">
        ...
        <SidebarExpanded className="w-full sm:w-1/4 md:w-1/5 lg:w-1/6">
          <li
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 transition-all duration-300">
        {isMainContent ? (
          <>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-100 mb-6">
              Welcome Back!
            </h2>
            ...
            <section className="mb-12">
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-200 mb-4">Recently Played</h3>
          ...
          <>
            <h2 className="text-3xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600 mb-8">
      ...
      {/* Player Section */}
      {showPlayer && songData && (
        <div className="bg-black p-6 fixed bottom-0 left-0 w-full z-10 sm:w-3/4 lg:w-1/2">
